...
try:
    task = EmployeeTask.objects.get(id=4)
    ...
    if task.stage.order_item:
        ...
        print(f"  OrderItem size: {task.stage.order_item.size}")
        print(f"  OrderItem color: {task.stage.order_item.color}")
    else:
